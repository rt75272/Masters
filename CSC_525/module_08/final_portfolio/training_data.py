...
training_data = [
    ...
    {"intent": "greet", "text": "hey, how are you?"},
    {"intent": "greet", "text": "hi, how's it going?"},
    {"intent": "greet", "text": "hello, anyone there?"},
    {"intent": "greet", "text": "yo bot"},
    {"intent": "greet", "text": "hey, can you help me?"},
    {"intent": "greet", "text": "hi, I need someone to talk to"},
    {"intent": "greet", "text": "hello friend"},
    {"intent": "greet", "text": "hey, just checking in"},
    # ANXIETY
    ...
    {"intent": "anxiety", "text": "I feel like I'm losing control"},
    {"intent": "anxiety", "text": "I can't relax no matter what"},
    {"intent": "anxiety", "text": "I feel like I'm going to faint"},
    {"intent": "anxiety", "text": "I get anxious before big events"},
    {"intent": "anxiety", "text": "I worry about my health a lot"},
    {"intent": "anxiety", "text": "I can't stop thinking about what could go wrong"},
    {"intent": "anxiety", "text": "I feel anxious in crowds"},
    {"intent": "anxiety", "text": "I get anxious when I'm alone"},
    {"intent": "anxiety", "text": "I feel like I can't escape my anxiety"},
    # DEPRESSION
    ...
    {"intent": "depression", "text": "I feel like nobody cares about me"},
    {"intent": "depression", "text": "I feel like I'm stuck in a dark place"},
    {"intent": "depression", "text": "I can't stop crying"},
    {"intent": "depression", "text": "I feel like I'm not good enough"},
    {"intent": "depression", "text": "I feel like my life has no purpose"},
    {"intent": "depression", "text": "I feel like I'm always tired"},
    {"intent": "depression", "text": "I feel like I'm failing at everything"},
    {"intent": "depression", "text": "I feel like I'm letting everyone down"},
    {"intent": "depression", "text": "I feel like I can't talk to anyone"},
    # ADHD
    ...
    {"intent": "adhd", "text": "I get distracted by noises"},
    {"intent": "adhd", "text": "I can't keep track of time"},
    {"intent": "adhd", "text": "I start projects but don't finish"},
    {"intent": "adhd", "text": "I have trouble following instructions"},
    {"intent": "adhd", "text": "I forget what people just told me"},
    {"intent": "adhd", "text": "I lose focus during conversations"},
    {"intent": "adhd", "text": "I feel overwhelmed by simple tasks"},
    {"intent": "adhd", "text": "I can't remember where I put things"},
    # GOODBYE
    ...
    {"intent": "goodbye", "text": "I'll talk to you another time"},
    {"intent": "goodbye", "text": "I'm signing off"},
    {"intent": "goodbye", "text": "catch you next time"},
    {"intent": "goodbye", "text": "until next time"},
    {"intent": "goodbye", "text": "peace out"},
    {"intent": "goodbye", "text": "later"},
    {"intent": "goodbye", "text": "see you around"},
]
